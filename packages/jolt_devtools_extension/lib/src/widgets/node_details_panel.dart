...
class _NodeDetailsPanelState extends State<NodeDetailsPanel>
  ...
  setup(BuildContext context) {
    ...
    return () {
      final displayedCreationStack =
          formatCreationStackForDisplay(widget.node.creationStack.value);
      ...
      return Column(children: [
        ...
        Expanded(
          ...
          DetailSection(
            ...
            children: [
              DetailRow(
                  ...
                  showCopyButton: true),
              DetailRow(
                  label: 'Type', value: widget.node.type, showCopyButton: true),
              DetailRow(
                  label: 'Debug Type',
              ...
              JoltBuilder(builder: (context) {
                ...
                return DetailRow(
                  label: 'Updated',
                  value: controller.formatTimeAgo(widget.node.updatedAt.value),
                );
              }),
              JoltBuilder(builder: (context) {
          ...
          if (displayedCreationStack.isNotEmpty) ...[
            const SizedBox(height: 16),
            DetailSection(
