...
class JoltEffectHook<T, S extends EffectBaseNode> extends Hook<S> {
  ...
  @override
  JoltEffectHookState<T, S> createState() => JoltEffectHookState();
}
...
/// disposal when the hook is removed from the widget tree.
class JoltEffectHookState<T, S extends EffectBaseNode>
    extends HookState<S, JoltEffectHook<T, S>> {
  ...
  @override
  Object? get debugValue => _instance;
